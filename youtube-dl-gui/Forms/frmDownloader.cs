    ...
    private void BeginDownload() {
        ...
        DownloadThread = new Thread(() => {
            ...
            try {
                ...
                CurrentDownload.Status = exitCode switch {
                    0 => DownloadStatus.Finished,
                    _ when CurrentDownload.Status == DownloadStatus.Aborted => DownloadStatus.Aborted,
                    _ when DownloadHelper.IsProcessUserInterruptExit(exitCode) => DownloadStatus.Aborted,
                    _ => DownloadStatus.YtdlError
                };
            }
