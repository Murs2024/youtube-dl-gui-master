...
internal static class Log {
    ...
    static Log() {
        ...
        try {
            ...
            AppDomain.CurrentDomain.UnhandledException += (sender, exception) => {
                ...
                if (ShouldSuppressBenignException(ExceptionRef)) {
                    return;
                }
            ...
            Application.ThreadException += (sender, exception) => {
                if (ShouldSuppressBenignException(exception.Exception)) {
                    return;
                }
    ...
    private static bool ShouldSuppressBenignException(Exception? ex) {
        for (Exception? e = ex; e is not null; e = e.InnerException) {
            if (e is ThreadAbortException or OperationCanceledException or TaskCanceledException) {
                return true;
            }
        }
        return false;
    ...
    public static DialogResult ReportException(Exception ReceivedException) {
        if (ShouldSuppressBenignException(ReceivedException)) {
    ...
    private static DialogResult DisplayException(ExceptionInfo ReceivedException, bool CanWriteToFile) {
        if (ShouldSuppressBenignException(ReceivedException.Exception)) {
            return DialogResult.Cancel;
        }
    ...
    public static DialogResult MessageBox(
        string Message) => WinMsg.Show(Form.ActiveForm, Message, Language.ApplicationDisplayName);
    ...
    public static DialogResult MessageBox(
        string Message,
        MessageBoxButtons Buttons = MessageBoxButtons.OK) => WinMsg.Show(Form.ActiveForm, Message, Language.ApplicationDisplayName, Buttons);
    ...
    public static DialogResult MessageBox(
        ...
        MessageBoxIcon Icon) => WinMsg.Show(Form.ActiveForm, Message, Language.ApplicationDisplayName, Buttons, Icon);
    ...
    public static DialogResult MessageBox(
        string Message,
        MessageBoxButtons Buttons,
        MessageBoxDefaultButton DefaultButton) => WinMsg.Show(Form.ActiveForm, Message, Language.ApplicationDisplayName, Buttons, MessageBoxIcon.None, DefaultButton);
    ...
    public static DialogResult MessageBox(
        ...
        MessageBoxButtons Buttons,
        MessageBoxIcon Icon,
        MessageBoxDefaultButton DefaultButton) => WinMsg.Show(Form.ActiveForm, Message, Language.ApplicationDisplayName, Buttons, Icon, DefaultButton);
    #endregion
}
