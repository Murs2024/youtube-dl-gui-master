...
public static class Language {
    #region Constants
    /// <summary>INI section name and technical id (do not rename — existing settings files).</summary>
    ...
    public static class InternalEnglish {
        ...
        public const string lbAboutBody = "Murs Media by {0}\nbuild date {1}\nGitHub: https://github.com/Murs2024";
        ...
        #region frmMain
        // frmMain
        public const string frmMain = "Murs Media";
        // frmMain / menu
        ...
        #region frmSettings
        public const string frmSettings = "Murs Media settings";
